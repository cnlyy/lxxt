				...
				<div class="news">
					...
					<div class="user_news">
						...
						<div style="padding-top: 10px">
							<a href="deleteTask.action?id=${u.id }"><button style="width: 50px; height: 30px; font-size: 14px;">删除</button></a>
						</div>
					</div>
					<!--==================================-->
					<div class="describe">
					...
					<div class="limit_time">
						...
						<p class="p_float4">${u.begintime } 至${t.endtime }</p>
					</div>
					<!--==================================-->
					<div class="help_him">
						<!--j接单-->
				...
				<tr>
					...
					<td class="td2"><span>第${pagemsg.currPage }/
							...
							每页显示:${pagemsg.pageSize}</span> <span> <c:if
								...
								<a
									href="${pageContext.request.contextPath }/Backstage_See_XuQiu_page.action?currentPage=1">[首页]</a>
								<a
									href="${pageContext.request.contextPath }/Backstage_See_XuQiu_page.action?currentPage=${pagemsg.currPage-1}">[上一页]</a>
							</c:if> <c:if
								test="${requestScope.pagemsg.currPage != requestScope.pagemsg.totalPage}">
								<a
									href="${pageContext.request.contextPath }/Backstage_See_XuQiu_page.action?currentPage=${pagemsg.currPage+1}">[下一页]</a>
								<a
									href="${pageContext.request.contextPath }/Backstage_See_XuQiu_page.action?currentPage=${pagemsg.totalPage}">[尾页]</a>
							</c:if>
					</span></td>
				</tr>
			</table>
