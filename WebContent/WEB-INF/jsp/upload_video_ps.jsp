	...
	<div
		...
		<div style="margin-top: 70px;">
			...
			<div class="content content-front" style="margin-top: -75px;">
				...
				<form action="uploadps.action" method="post" enctype="multipart/form-data" onsubmit="return check()">
					<div class="box">
						<div class="file_box">
							<div class="file_name">
								<p class="p_file_name">名称</p>
								<input class="input_name" placeholder=" 请输入视频名" name="psvideo_name"  required="required" maxlength="20"  >
							</div>
							<div class="file_jianjie">
								<p class="p_file_jianjie">简介</p>
								<textarea class="input_jianjie" placeholder=" 请输入视频简介" name="psvideo_introduce"></textarea>
							</div>
							<div class="upload_box">
								<input type="file" id="file" multiple="multiple" name="ps_video" required="required" maxlength="45"  />
							</div>
