						...
						<div
							...
							<div class="text">
								<ul>
									...
									<li class="active"><a href="#"> <em>PS</em>
									</a></li>
									<li><a
							...
							<div class="b_c">
								...
								<div class="video_name">
									...
									<p class="p_video_name">
										<%-- <a
										href="toPS_videos_paly.action?name=${u. psvideo_name }&introduce=${u.psvideo_introduce }&route=${u.psvideo_route }"
										class="link_name">${u. psvideo_name}</a> --%>
										<a href="toPS_videos_paly.action?id=${u.id }"
											class="link_name">${u. psvideo_name}</a>
									</p>
								</div>
								<div class="video_explain_box">
									<!--装视频说明-->
									<p class="p_video_explain">${u.psvideo_introduce }</p>
								</div>
							</div>
						</c:forEach>
						</div>
									...
									<tr>
										...
										<td class="td2"><span>第${pagemsg.currPage }/
												...
												每页显示:${pagemsg.pageSize}</span> <span> <c:if
													...
													<a
														href="${pageContext.request.contextPath }/PS_page.action?currentPage=1">[首页]</a>
													<a
														href="${pageContext.request.contextPath }/PS_page.action?currentPage=${pagemsg.currPage-1}">[上一页]</a>
												</c:if> <c:if
													test="${requestScope.pagemsg.currPage != requestScope.pagemsg.totalPage}">
													<a
														href="${pageContext.request.contextPath }/PS_page.action?currentPage=${pagemsg.currPage+1}">[下一页]</a>
													<a
														href="${pageContext.request.contextPath }/PS_page.action?currentPage=${pagemsg.totalPage}">[尾页]</a>
												</c:if>
										</span></td>
									</tr>
								</table>
