			...
			<div class="video_box">
				...
				<div class="video">
					...
					<video class="video_play" controls="controls"> <source
						src="${pageContext.request.contextPath }/videos/${PRVIDEO.prvideo_route }" type="video/mp4"></video>
				</div>
				<div class="jianjie">
					<!--右侧-->
					...
					<div class="video_name">
						...
						<div class="name_box2">
							<!--xxx-->
							<p class="p_name_box2">${PRVIDEO.prvideo_name }</p>
						</div>
					</div>
					<!--*********************************-->
					<div class="video_jianjie">
						...
						<div class="jianjie_box2">
							<!--xxxxxxx-->
							<p class="p_jianjie_box2">${PRVIDEO.prvideo_introduce }</p>
						</div>
					</div>
					<div
						style="width: 100%; margin-top: 5px; text-align: center; background: #908C7A;">
						<a href="${pageContext.request.contextPath }/toUpload_video.action" target="view_window">
