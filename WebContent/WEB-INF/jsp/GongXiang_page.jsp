...
<script type="text/javascript">
	function toupload() {
		document.forms.form1.action = "toUpload_video.action";
		document.forms.form1.submit();
	}
</script>
<script type="text/javascript">
	function touploadps() {
		document.forms.form1.action = "toUpload_video_ps.action";
		document.forms.form1.submit();
	}
</script>
</head>
...
<body>
	...
	<div style="width: 100%;">
						...
						<div
							...
							<div class="text">
								<ul>
									...
									<li class="active"><a href="#"> <em>资源共享</em>
									</a></li>
									<%-- <li><a
		...
		<form id="form1" action="shareResource.action" method="post">
			<div class="share_box">
				<div class="title">
					<p class="p_title">我有资源</p>
				</div>
				<div class="link_type">
					<p class="p_link_type">类型</p>
					<input class="link_type_input" placeholder=" 例如：PR资源" name="name"  required="required" maxlength="20"  />
				</div>
				<div class="_link">
					<p class="p_link">链接</p>
					<input class="link_input" placeholder=" 例如：www.xxxxx.com"  required="required" 
						name="link" />
				</div>
				<div class="btn">
					<button class="btn_button"
						onmouseover="this.style.backgroundColor='#E4D6D3';"
						onmouseout="this.style.backgroundColor='';" type="submit">分
						享</button>
					<button class="btn_button"
						onmouseover="this.style.backgroundColor='#E4D6D3';"
						onmouseout="this.style.backgroundColor='';" type="button"
						onclick="toupload()">上传PR视频</button>
					<button class="btn_button"
						onmouseover="this.style.backgroundColor='#E4D6D3';"
						onmouseout="this.style.backgroundColor='';" type="button"
						onclick="touploadps()">上传PS视频</button>
				</div>
			</div>
		...
		<div class="all_link_box">
			<table class="all_link_title">
				...
				<!-- <tr class="tr_link">
					<td class="link1"><p class="p_link1">111111</p></td>
					<td class="link2" style=""><p class="p_link2">111111111</p></td>
					<td class="link3"><p class="p_link3">11111111</p></td>
				</tr>
				<tr class="tr_link">
